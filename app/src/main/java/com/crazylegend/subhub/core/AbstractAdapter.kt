 ...
 */
abstract class AbstractAdapter<T, VH : RecyclerView.ViewHolder>(diffCallback: DiffUtil.ItemCallback<T>,
    ...
    override fun onBindViewHolder(holder: VH, position: Int) {
        ...
        holder.itemView.setOnClickListenerCooldown {
            it?.let { view -> forItemClickListener?.forItem(position, item, view = view) }
        }
    ...
    private fun setViewHolder(inflatedView: View): VH {
        return viewHolder.declaredConstructors.first().newInstance(inflatedView) as VH
    }
